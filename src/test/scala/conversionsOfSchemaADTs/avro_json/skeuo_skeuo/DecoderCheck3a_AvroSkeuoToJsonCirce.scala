...
class DecoderCheck3a_AvroSkeuoToJsonCirce(implicit imp: ImplicitArgs )
	...
	val skeuoJson_fromTransOfAvroSkeuoFromStr: Fix[JsonSchema_S] = avroToJson_byCataTransAlg(skeuoAvro_fromStr)
	...
	val circeJson_fromJson: JsonCirce = libRender(skeuoJson_fromTransOfAvroSkeuoFromStr)
