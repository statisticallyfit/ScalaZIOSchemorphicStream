...
// *
// */
//class AvroSchema_SkeuoApacheRoundTrip_Skeuopecs extends AnyWordSpec with Matchers with GeneralTestUtil {
...
//			getFuncTypeSubs(coalgebra_ApacheToSkeuo) shouldEqual "Coalgebra[SchemaAvro_Skeuo,SchemaAvro_Apache]"
...
//			val funcTypeAnamorphismOfCoalgebra: String = getFuncTypeSubs(scheme.ana(coalgebra_ApacheToSkeuo).apply(_))
//			val funcTypeApacheToSkeuo: String = getFuncTypeSubs(apacheToSkeuoAvroSchema)
//
...
//			getFuncTypeSubs(algebra_SkeuoToApache) shouldEqual "Algebra[SchemaAvro_Skeuo,SchemaAvro_Apache]"
//			algebra_SkeuoToApache shouldBe a [Algebra[SchemaAvro_Skeuo, SchemaAvro_Apache]]
//
//
//			// type-check -- for the extracted algebra type
//			val funcTypeCatamorphismOfAlgebra: String = getFuncTypeSubs(scheme.cata(algebra_SkeuoToApache).apply(_))
//			val funcTypeSkeuoToApache: String = getFuncTypeSubs(skeuoToApacheAvroSchema)
//
...
//				apacheToSkeuoAvroSchema shouldBe a [SchemaAvro_Apache => SchemaAvro_Skeuo[_]]
//
//				getFuncTypeSubs(apacheToSkeuoAvroSchema) shouldEqual "SchemaAvro_Apache => Fix[SchemaAvro_Skeuo]"
//				getFuncTypeSubs(scheme.ana(coalgebra_ApacheToSkeuo).apply(_)) shouldEqual "SchemaAvro_Apache => Fix[SchemaAvro_Skeuo]"
//
//
...
//				getFuncTypeSubs(strSchema_Skeuo) shouldEqual "Fix[SchemaAvro_Skeuo]"
...
//				skeuoToApacheAvroSchema shouldBe a [SchemaAvro_Skeuo[_] => SchemaAvro_Apache]
//
//				getFuncTypeSubs(skeuoToApacheAvroSchema) shouldEqual "Fix[SchemaAvro_Skeuo] => SchemaAvro_Apache"
//				getFuncTypeSubs(scheme.cata(algebra_SkeuoToApache).apply(_)) shouldEqual "Fix[SchemaAvro_Skeuo] => SchemaAvro_Apache"
//
//
//				// value-check --- for conversion result
//				val strSchema_Skeuo: Fix[SchemaAvro_Skeuo] = apacheToSkeuoAvroSchema(strSchema_Apache)
...
//
//				getFuncTypeSubs(strSchema_Skeuo) shouldEqual "Fix[SchemaAvro_Skeuo]"
//				getFuncTypeSubs(strSchemaBack_Apache) shouldEqual "SchemaAvro_Apache"
//
//			}
//
...
//				getFuncTypeSubs(roundTrip_ApacheAvroToApacheAvro) shouldEqual "SchemaAvro_Apache => SchemaAvro_Apache"
//
...
//				getFuncTypeSubs(roundTrip_SkeuoAvroToSkeuoAvro) shouldEqual "Fix[SchemaAvro_Skeuo] => Fix[SchemaAvro_Skeuo]"
//			}
//		}
//
//		// -----------------------------------------------------------------------------------------------
...
//					getFuncTypeSubs(sch) shouldEqual "SchemaAvro_Apache"
//				)
//				// TODO left off here to check if this runs and compiles
//				arraySchemas_Skeuo.map((sch: Fix[SchemaAvro_Skeuo]) ⇒
//					getFuncTypeSubs(sch) shouldEqual "Fix[SchemaAvro_Skeuo]"
//				)
//				arraySchemas_Apache.map((sch: SchemaAvro_Apache) ⇒
...
//
//				getFuncTypeSubs(arrayIntSchema_Skeuo) shouldEqual "Fix[SchemaAvro_Skeuo]"
//				getFuncTypeSubs(arrayIntSchemaBack_Apache) shouldEqual "SchemaAvro_Apache"
//
//			}
//
//			// TODO refactor this fucntion to show cata-ana-hylo (type and value checks)
...
//
//
//	//println(s"FUNC TYPE: avroSchemaToJsonString: ${getFuncTypeSubs(skeuoAvroSchemaToJsonCirce, keepPckgs, classesToSubs)}")
//
//
