...
//						case Some(RecordType.Period) => {
//							val res: Right[Nothing, Schema[Period]] = Right(Schema.primitive(StandardType.PeriodType))
//						}
...
//					}
//				case SchemaAvro.Type.ENUM => {
//					val res: scala.Either[String, Schema[_]] = toZioStringEnum(avroSchema)
//				}
