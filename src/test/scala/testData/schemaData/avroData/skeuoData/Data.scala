...
object Data {
	...
	val enumAvro_Fix_S: Fix[AvroSchema_S] = Fix(TEnum(name = "Colors", namespace = None,aliases = List(),doc = None,symbols = List("Red", "Orange", "Pink", "Yellow", "Green", "Blue", "Indigo", "Violet")))
